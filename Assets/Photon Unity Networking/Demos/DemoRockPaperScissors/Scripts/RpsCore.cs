...
{
    [SerializeField]
    private RectTransform RoomUiView;
    ...
    public void Start()
    {
        ...
        RoomUiView.gameObject.SetActive(false);
	...
	void RefreshUIViews()
	{
        ...
        Debug.Log("C " + PhotonNetwork.insideLobby);
        //RoomUiView.gameObject.SetActive(PhotonNetwork.connecting);

        
        //ConnectUiView.gameObject.SetActive(!PhotonNetwork.inRoom);//&& !PhotonNetwork.inRoom
    ...
    public override void OnLeftRoom()
    {
        ...
        RoomUiView.gameObject.SetActive(true);
        GameUiView.gameObject.SetActive(false);
    }
